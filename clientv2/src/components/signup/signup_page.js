...
function SignUp() {
    ...
    const [qr, setQr] = useState(false); // State variable for qr
    const [qrCode, setQrCode] = useState(""); // State variable for qrCode
    ...
    async function onSubmit(e) {
        ...
        if (selectedMemberTypes[0] == "Coach") {
            ...
            setQrCode(data.qr); // Update qrCode state
        ...
        return (
            <div className="d-flex justify-content-center align-items-center">
                <div>
                    ...
                    <img src={qrCode} alt="qr" style={{ display: "block", margin: "0 auto" }} />
                    <h4 className="text-center warning-text">Warning, Please scan QR code with google authenticator as it will only be shown Once</h4>
                ...
                <form className="form-container" onSubmit={onSubmit}>
                    ...
                    <div id="Member_type" className="mb-3">
                        ...
                        <div className="mb-3 form-check">
                            <input type="radio" className="form-check-input" id="Coach" name="memberType" value="coach" />
                            <label className="form-check-label" htmlFor="coach">Coach</label>
                        </div>
                        <div className="mb-3 form-check">
                            <input type="radio" className="form-check-input" id="Exco" name="memberType" value="exco" />
                            <label className="form-check-label" htmlFor="exco">Exco</label>
                        </div>
                        <div className="mb-3 form-check">
                            <input type="radio" className="form-check-input" id="Members" name="memberType" value="member" />
