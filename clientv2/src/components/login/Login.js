    ...
    async function loginMember(event) {
        ...
        if (selectedMemberTypes[0] === "Coach") {
            ...
            if (data.coach) {
                ...
                alert('Please check your username, password and six digit code on Google Authenticator')
            }
    ...
    return (
        <div style={{
            ...
            <form className='form-container' onSubmit={loginMember}>
                ...
                <div className='mb-3 form-style'>
                    <label htmlFor="sixDigitCode" className="form-label">
                        Six Digit Code On Google Authenticator
                    </label>
                    <input
                        value={sixDigitCode}
                        className='form-control'
